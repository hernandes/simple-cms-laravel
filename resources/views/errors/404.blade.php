...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>404 - @lang('web.errors.404.title')</title>

        <link type="text/css" rel="stylesheet" href="{{ asset('css/web/404.css') }}" />
    </head>
    <body>
        <main>
            <svg
            ...
            <p id="error-text">@lang('web.errors.404.title')</p>
            <a id="error-link" href="{{ url('/') }}">@lang('web.actions.back')</a>
        </main>
    </body>
</html>
